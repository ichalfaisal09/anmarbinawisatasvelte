...
function FeedPost($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		if (logo()) {
			$$renderer.push("<!--[0-->");
			$$renderer.push(`<img class="avatar-img svelte-1pqho8u"${attr("src", logo())} alt="" width="36" height="36"/>`);
		} else {
			$$renderer.push("<!--[-1-->");
		...
		$$renderer.push(`<!--]--> <img${attr("src", imageUrl)}${attr("alt", imgAlt())}${attr_class("media-img svelte-1pqho8u", void 0, { "media-img--loaded": imageLoaded })}${attr("loading", priorityImage ? "eager" : "lazy")}${attr("fetchpriority", priorityImage ? "high" : "low")} decoding="async" onload="this.__e=event" onerror="this.__e=event"/></div> <div class="post-content svelte-1pqho8u"><h2 class="title svelte-1pqho8u">${escape_html(title)}</h2> <a${attr("href", waLink())}${attr_class("btn-action svelte-1pqho8u", void 0, { "disabled": waLink() === "#" })} target="_blank" rel="noopener noreferrer"${attr("aria-disabled", waLink() === "#")}>Daftar via WhatsApp</a> `);
		if ((officeHours ?? "").trim()) {
			$$renderer.push("<!--[0-->");
...
//# sourceMappingURL=_page.svelte-DQIau2kk.js.map
