...
var GALLERY_UPLOADS_DIR = path.resolve(process.cwd(), "static", "uploads", "gallery");
...
async function writeGalleryUpload(file, ext) {
	...
	await writeFile(path.join(GALLERY_UPLOADS_DIR, filename), Buffer.from(await file.arrayBuffer()));
...
const index = 7;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-CdjjwIQ4.js')).default;
const server_id = "src/routes/admin/gallery/+page.server.ts";
const imports = ["_app/immutable/nodes/7.CqpIyNIs.js","_app/immutable/chunks/DKj7emCc.js","_app/immutable/chunks/CuyqONxg.js"];
const stylesheets = ["_app/immutable/assets/7.DDTCHP0g.css"];
const fonts = [];

export { component, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=7-BTCXDhuC.js.map
